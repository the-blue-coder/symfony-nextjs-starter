...
2. **Duplicate the n8n workflow** — go to https://n8n.madainsight.com/workflow/PWe4ZS7OlR3KzoDa, duplicate it, and update the HTTP request node URL and `X-Backup-Secret` header to match this project.
